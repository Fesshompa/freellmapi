...
export const modelFailureTimestamps = new Map<number, number[]>(); // model_db_id → times
...
export const emptyCompletionStreaks = new Map<string, number>(); // "platform:modelId:keyId"
